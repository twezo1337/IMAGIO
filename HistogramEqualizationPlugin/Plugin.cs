...
namespace HistogramEqualizationPlugin
{
    public class Plugin : Iplugin
    {
        private string _IconSrc = "~/img/histogram.svg";
        private string _Name = "Гистограмма выравнивания";
        ...
        public string Function(string src, int id, int width = 0, int height = 0, float value = 0, int g = 0, int b = 0)
        {
            ...
            {
                img.Mutate(x => x.HistogramEqualization());
                img.Save(".." + src.Split(".")[2] + $"_{id}" + "." + src.Split(".").Last());
            }
            return $"+ Гистограмма выравнивания ";
        }
